...
function ExperienceCard({title, company, companyLogo, startDate, endDate, summary, skills}: Props) {
  return (
    <article className='flex flex-col rounded-lg items-center space-y-7 flex-shrink-0 w-80 md:w-[500px] lg:w-[600px] xl:w-[900px] snap-center bg-[#292929] py-10 hover:opacity-100 opacity-40 cursor-pointer transition-opacity duration-200 overflow-y-scroll overflow-x-hidden scrollbar scrollbar-track-gray-400/20 scrollbar-thumb-[#94160d]/60'>
