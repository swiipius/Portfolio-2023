...
function Skills({}: Props) {
  return (
    <motion.div 
        ...
        className='h-screen flex relative overflow-hidden flex-col text-center md:text-left md:flex-row max-w-[2000px] xl:px-10 min-h-screen justify-center xl:space-y-10 mx-auto items-center'
    >
        ...
        <div className='grid md:grid-cols-6 grid-cols-4 gap-5 mx-5 h-1/2'>
            <Skill level='90%' logo='/images/Logo/vs.svg' name='vs code'/>
            <Skill level='90%' logo='/images/Logo/github.svg' name='Github'/>
            <Skill level='90%' logo='/images/Logo/platformio.svg' name='POlatformIO'/>
            ...
            <Skill level='80%' logo='/images/Logo/c++.svg' name='C++' />
            ...
            <Skill level='10%' logo='/images/Logo/zigbee.svg' name='Zigbee' /> 
