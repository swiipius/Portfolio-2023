...
function Skill({level, logo, css, name}: Props) {
  return (
    <div className='group relative flex cursor-pointer aspect-square overflow-hidden'>
        <Image src={logo} alt='' width={100} height={100} className={'border-gray-500 filter group-hover:grayscale transition duration-300 ease-in-out h-12 w-12 md:w-28 md:h-28 object-contain ' + css} />
