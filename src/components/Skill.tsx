...
function Skill({level, logo, css}: Props) {
  return (
    <div className='group relative flex cursor-pointer aspect-square'>
        <Image src={logo} alt='' width={40} height={40} className={'border-gray-500 filter group-hover:grayscale transition duration-300 ease-in-out h-10 w-10 md:w-16 md:h-16 object-contain ' + css} />
